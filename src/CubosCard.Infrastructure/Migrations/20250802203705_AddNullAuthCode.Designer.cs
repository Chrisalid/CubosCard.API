...
namespace CubosCard.Infrastructure.Migrations
{
    ...
    [Migration("20250802203705_AddNullAuthCode")]
    partial class AddNullAuthCode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CubosCard.Domain.Entities.ExternalAuthentication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_external_authentication");

                    b.HasIndex("Email")
                        .IsUnique()
                        .HasDatabaseName("ix_external_authentication_email");

                    b.ToTable("ExternalAuthentication", (string)null);
                });

            modelBuilder.Entity("CubosCard.Domain.Entities.ExternalAuthenticationToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ExternalAccessToken")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("external_access_token");

                    b.Property<Guid>("ExternalAuthenticationId")
                        .HasColumnType("uuid")
                        .HasColumnName("external_authentication_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_external_authentication_token");

                    b.HasIndex("ExternalAuthenticationId")
                        .HasDatabaseName("ix_external_authentication_token_external_authentication_id");

                    b.ToTable("ExternalAuthenticationToken", (string)null);
                });
            ...
            modelBuilder.Entity("CubosCard.Domain.Entities.ExternalAuthenticationToken", b =>
                {
                    b.HasOne("CubosCard.Domain.Entities.ExternalAuthentication", "ExternalAuthentication")
                        .WithMany("ExternalAuthenticationTokens")
                        .HasForeignKey("ExternalAuthenticationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_external_authentication_token_external_authentication_external");

                    b.Navigation("ExternalAuthentication");
                });
            ...
            modelBuilder.Entity("CubosCard.Domain.Entities.ExternalAuthentication", b =>
                {
                    b.Navigation("ExternalAuthenticationTokens");
                });
